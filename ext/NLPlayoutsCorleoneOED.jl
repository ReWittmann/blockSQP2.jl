...
function NLPlayouts.get_preLayouts(OED::OEDLayer,
    ...
    return NLPlayouts.get_preLayouts(OED.layer, ps, st; name = name)
end

function NLPlayouts.get_preLayouts(MultiExp::MultiExperimentLayer,
    ...
    subPreLayouts = ((NLPlayouts.get_preLayouts(MultiExp.layers[i], ps[Symbol(:experiment_, i)], st[Symbol(:experiment_, i)]; name = Symbol(name, :_, i))
